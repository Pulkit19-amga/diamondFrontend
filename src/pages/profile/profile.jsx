...
const Profile = () => {
  return (
    <>
       <section className="profile_tab page-my-account" style={{marginTop:'40px',marginBottom:'40px'}} >
      <div className="container">
        <div className="row">
          <div className="col-xl-4 col-lg-4 col-md-4 col-sm-12 col-12">
            <div className="account-sidebar p-2">
              <div className="sidebar-top flex-sm align-items_center">
                <h1 className="text-uppercase" role="heading" aria-level="2">My Account</h1>
              </div>
              <div className="nav flex-column nav-pills" id="v-pills-tab" role="tablist" aria-orientation="vertical">
                <button
                  ...
                  aria-selected="true"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="16.047" height="17.912" viewBox="0 0 16.047 17.912">
                    <path
                ...
                <button
                  ...
                  aria-selected="false"
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="14" height="17.694" viewBox="0 0 13.434 17.694">
                    <path
              ...
              <div className="btn-wrapper small--hide">
                <a href="#" className="btn btn-wide">Log out</a>
              </div>
            </div>
          </div>
  ...
  <div className="tab-content" id="v-pills-tabContent" style={{alignItems:'start !important'}}>
    ...
    <div className="tab-pane fade" id="v-pills-address" role="tabpanel" aria-labelledby="v-pills-view_address">
              ...
              <div className="individual-address-list">
                <div className="address">
                  ...
                  <div className="customer-address">
                    <p>Radhika Gour<br />United States</p>
                  </div>
                ...
                >
                  <svg xmlns="http://www.w3.org/2000/svg" width="9" height="9" viewBox="0 0 9 9">
                    <g transform="translate(0.5 0.5)">
                      <line y2="8" transform="translate(4)" stroke="#181a1d" strokeLinecap="round" strokeWidth="1" />
                      <line x2="8" transform="translate(0 4)" stroke="#181a1d" strokeLinecap="round" strokeWidth="1" />
                    </g>
                  </svg>
                  Add a New Address
                </button>
    ...
    <div className="tab-pane fade" id="v-pills-financing_tab" role="tabpanel" aria-labelledby="v-pills-financing">
      <div className="grid__item grid__account-details">
        <div className="details-header">
        ...
        <div className="my-account-financing">
          ...
          <p>
            We offers customers a credit card through Synchrony Bank with a revolving credit line to use again and again
            at withclarity.com.
          </p>
          <p>
            ...
            >
              <b>here</b>
            </a>. Get a decision instantly.
          </p>
          <h3>No interest for 12 Months**</h3>
          <p>
            No interest on purchases of $199 or more with your Synchrony Financial credit card. Interest will be charged to
            your account dated from time of purchase if the full amount is not paid within 12 months. Set minimum monthly
          ...
          <div className="finance-cart flex-md text-center d-flex">
            {[
              ...
              <div className="col medium-up--one-quarter" key={index}>
